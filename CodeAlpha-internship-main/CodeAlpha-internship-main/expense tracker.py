...
# Add button to fill current date
fill_date_button = tk.Button(root, text="Fill Today's Date", command=fill_current_date)
fill_date_button.grid(row=0, column=2, padx=5, pady=5)
